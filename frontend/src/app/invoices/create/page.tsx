      ...
      <div className="bg-white p-6 rounded-lg shadow mb-6">
        ...
        <div className="relative" ref={dropdownRef}>
          <div className="relative">
            <input
              type="text"
              placeholder="Click to search and select customer..."
              value={searchTerm}
              onChange={(e) => {
              ...
              className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FF6B35] cursor-pointer"
            />
            {/* Search icon */}
            <svg 
          ...
          {showCustomerDropdown && (
            <div className="absolute z-20 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-xl max-h-80 overflow-auto">
              {filteredCustomers.length > 0 ? (
                <>
                  <div className="px-3 py-2 text-sm text-gray-500 bg-gray-50 border-b">
                  ...
                  {filteredCustomers.slice(0, 20).map(customer => (
                    <div
                      ...
                      className={`px-4 py-3 hover:bg-[#FFF5F2] cursor-pointer border-b last:border-b-0 transition-colors ${
                        selectedCustomer === customer.id ? 'bg-[#FFF5F2]' : ''
                      }`}
                    >
        ...
        {selectedCustomer && (
          <div className="mt-4 p-4 bg-[#F8FAFB] border border-[#E5E7EB] rounded-lg">
            {(() => {
              ...
              return customer ? (
                <div>
                  ...
                  <div className="text-sm text-gray-600 space-y-1">
                    <p><span className="font-medium">Contact:</span> {customer.contactName}</p>
                    <p><span className="font-medium">Address:</span> {customer.street}</p>
                    <p className="pl-12">{customer.city}, {customer.province} {customer.postalCode}</p>
